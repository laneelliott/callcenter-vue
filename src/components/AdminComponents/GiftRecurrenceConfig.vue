<template>
    <div class="card">
        <h5 class="card-header"><i class="fas fa-pencil-alt float-left edit-btn" aria-expanded="false" @click="toggleEdit"></i>Gift Recurrence<i class="fas fa-plus float-right add-btn" @click="add"></i></h5>
