<template>
    <div class="card">
        <h5 class="card-header" @click.self="toggleEdit"><i class="fas fa-pencil-alt float-left edit-btn" aria-expanded="false"></i>Gift Recurrence<i class="fas fa-plus float-right add-btn" @click="add"></i></h5>
